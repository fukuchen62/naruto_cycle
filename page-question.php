...
<main>
    ...
    <section class="qaa">
        ...
        <div class="accordion-container">
            ...
            <dl class="accordion-list">
                <!-- 質問 -->
                <dt class="accordion-title js-accordion-title"> <img class="question_q_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/question_a_img.svg" alt="質問アイコン画像">
