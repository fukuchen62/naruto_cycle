...
<body>
    ...
    <footer class="footer bg_blue white txt_c debug">
        ...
        <div class="sns_container flex gap32_16">
            <!-- twitter -->
            <a href=""><img class="sns_icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/twitter_social_icons_circle_blue.png" alt="ツイッターアイコン"></a>
            <!-- facebook -->
            <a href=""><img class="sns_icon" src="<?php echo get_template_directory_uri(); ?>/assets/img/f_logo_RGB-Blue_144.png" alt="ツイッターアイコン"></a>
        </div>
