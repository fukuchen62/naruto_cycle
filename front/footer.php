...
<footer class="footer bg_blue white txt_c">
    ...
    <div class="sns_container flex gap32_16">
        <!-- twitter -->
        <a href=""><img class="sns_icon" src="./assets/image/index_footer_sharetwitter.png" alt=" Twitterへのシェアボタン"></a>
        <!-- facebook -->
        <a href=""><img class="sns_icon" src="./assets/image/index_footer_sharefb.png" alt="Facebookへのシェアボタン"></a>
    </div>
    <p class="copyright txt_c">AllCopyRight©なるとサイくるっと！</p>
</footer>

<!-- トップに戻るボタン -->
<div class="pagetop debug">
    <!-- 戻るボタン画像 -->
    <img src="./assets/image/aboutsite_sudachi_img.jpg" alt="トップに戻るボタン">
</div>
<!--＝＝＝＝＝＝＝＝＝＝＝＝＝ footerここまで ＝＝＝＝＝＝＝＝＝＝＝＝＝-->
...
<script src="./assets/js/3wave.js"></script>
</div>
</body>
